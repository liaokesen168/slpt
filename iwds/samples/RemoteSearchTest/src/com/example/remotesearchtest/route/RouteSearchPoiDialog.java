...
public class RouteSearchPoiDialog extends Dialog implements
    ...
    private List<RemotePoiItem> poiItems;
    ...
    public RouteSearchPoiDialog(Context context, List<RemotePoiItem> poiItems) {
        this(context, android.R.style.Theme_Dialog);
    ...
    public interface OnListItemClick {
        public void onListItemClick(RouteSearchPoiDialog dialog, RemotePoiItem item);
    }
