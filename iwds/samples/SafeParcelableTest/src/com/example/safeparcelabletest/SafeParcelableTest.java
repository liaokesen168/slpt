...
public class SafeParcelableTest extends Activity implements DataTransactorCallback {
    private String m_uuid = "a13c19e2-17a4-0797-9352-aca0dd4b886f";
    private SafeParcelTransactor<SafeParcelableClass> m_transactor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_transactor = new SafeParcelTransactor<SafeParcelableClass>(this,
                SafeParcelableClass.CREATOR, this, m_uuid);
    }
