...
public abstract class Picture {
	...
	public static class PictureContainer {
		...
		private static native void addPictureGroup(String groupName);

		private static native void addPicture(String pictureName, int width,
				int height, int[] mem);
	...
	public static class ImagePicture extends Picture {
		...
		public void decodeBitmap() {
			...
			if (mem != null) {
				bitmap = BitmapFactory.decodeByteArray(mem, 0, 0);
				super.bitmap = bitmap;
				return;
			}
